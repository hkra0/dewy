...
const translations = {
    en: {
        ...
        retake_confirm: "Today already has a photo — tap again within 3s to overwrite it.",
    ...
    zh: {
        ...
        daily_photo: "每日照片", photo_hour: " 每日拍照时刻 (点)",
        retake_photo: "重新拍摄当日照片", retake_confirm_btn: "再点一次以覆盖",
        retake_confirm: "当日已有照片，3 秒内再点一次将覆盖它。",
