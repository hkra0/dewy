...
const translations = {
    en: {
        ...
        pump_ready: "Watering safety is normal. Manual and automatic watering are allowed.",
        pump_manual_stopped: "Manual emergency stop active. All pump actions are paused.",
        pump_sensor_locked: "Soil reading dropped suddenly. Interlock active, waiting for stable readings ({count}/{needed}).",
        pump_both_locked: "Both manual emergency stop and sensor safety interlock are active.",
        pump_emergency_stop: "Emergency stop pump", pump_emergency_release: "Release",
    ...
    zh: {
        ...
        pump_ready: "安全状态正常，允许手动与自动浇水。",
        pump_manual_stopped: "人工急停已开启，水泵所有供水动作已暂停。",
        pump_sensor_locked: "土壤读数骤降触发联锁，等待读数回稳（已确认 {count}/{needed} 次）。",
        pump_both_locked: "人工急停与传感器联锁同时生效中，供水动作已暂停。",
        pump_emergency_stop: "水泵急停", pump_emergency_release: "解除",
