...
const translations = {
    en: {
        ...
        auto_water: "Auto Watering", threshold: "Threshold (%)", duration: "Duration (s)", water_hour: "Check Hour", fill_light: "Fill Light",
    ...
    zh: {
        ...
        auto_water: "自动浇水", threshold: "湿度阈值 (%)", duration: "浇水时长 (秒)", water_hour: "检测时刻 (整点)", fill_light: "补光灯",
