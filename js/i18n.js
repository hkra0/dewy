...
const translations = {
    en: {
        ...
        auto_water: "Auto Watering", threshold: "Trigger Threshold (%)", water_target: "Target Moisture (%)", duration: "Pulse Duration (s)", water_pulse_interval: "Pulse Interval (s)", water_max_pulses: "Max Pulses", water_min_interval: "Min Interval (hours)", water_hour: "Earliest Hour", fill_light: "Fill Light",
    ...
    zh: {
        ...
        auto_water: "自动浇水", threshold: "触发湿度下限 (%)", water_target: "目标湿度上限 (%)", duration: "单次脉冲时长 (秒)", water_pulse_interval: "脉冲间隔 (秒)", water_max_pulses: "最大脉冲数", water_min_interval: "最小间隔 (小时)", water_hour: "最早检测时刻 (整点)", fill_light: "补光灯",
